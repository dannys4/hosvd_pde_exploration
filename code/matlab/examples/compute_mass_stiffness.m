function [M,K] = compute_mass_stiffness(x,e_conn)
%%----------------------------------------------------------------------
%  compute_mass_stiffness - computes a mass matrix \int(h_i(x) h_j(x)) dx
...
%  Version: 1.3
%
%  Usage:    [M,K] = compute_mass_stiffness( x , e_conn );
%
%  Variables:  x      
%                      nodal coordinates
%              e_conn
